...
public class HttpDownloadHelper
{
    ...
    public static async void Download(string downloadUrl, string filePath, string fileName)
    {
        ...
        // Create a file stream to store the downloaded data. This really can be any type of
        // writeable stream.
        ...
        {
            // Use the custom extension method below to download the data. The passed
            // progress-instance will receive the download status updates.
...
public static class HttpClientExtensions
{
    public static async Task DownloadAsync(this HttpClient client, string requestUri, Stream destination, IProgress<float> progress = null, CancellationToken cancellationToken = default)
    {
        ...
        using (var response = await client.GetAsync(requestUri, HttpCompletionOption.ResponseHeadersRead))
        {
            ...
            {
                // Ignore progress reporting when no progress reporter was passed or when the

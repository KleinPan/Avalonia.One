...
/// <summary>主要用于get post请求 新方案告别 HttpClient 痛点：深入解析 .NET HttpClientFactory 的设计与最佳实践</summary>
public class HTTPClientHelper
{
    ...
    private static string BuildParam(Dictionary<string, string> paramArray, Encoding? encoding = null)
    {
